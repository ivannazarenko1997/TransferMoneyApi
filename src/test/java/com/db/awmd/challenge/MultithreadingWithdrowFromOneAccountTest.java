...
@SpringBootTest
public class MultithreadingWithdrowFromOneAccountTest {
    ...
    private static final BigDecimal ACCOUNT_1_AMOUNT = BigDecimal.valueOf(11000);
    private static final BigDecimal ACCOUNT_2_AMOUNT = BigDecimal.valueOf(0);

    private static final BigDecimal ACCOUNT_1_AMOUNT_RESULT = BigDecimal.valueOf(1000);
    private static final BigDecimal ACCOUNT_2_AMOUNT_RESULT = BigDecimal.valueOf(10000);
    ...
    public void runMultiplyThreadsForTransferService() throws Exception {
        ...
        for (int i = 0; i < NUMBER_OF_OPERATION; i++) {
            Callable<Transfer> callableTask = () -> {
                Transfer transfer = new Transfer(ACCOUNT_NAME_1, ACCOUNT_NAME_2, TRANSFER_AMOUNT);
